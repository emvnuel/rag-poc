 ...
 * in chat responses. The {@code id} and {@code chunkIndex} fields allow users to trace
 * AI-generated responses back to specific document chunks.</p>
 * 
 * <h3>Metadata Fields</h3>
 * <ul>
 *   <li><b>id</b>: Document identifier (UUID) - null for synthesized answers</li>
 ...
 * </pre>
 * 
 * @param id Document identifier (UUID) - identifies the source document; null for synthesized answers
